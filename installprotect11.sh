    ...
    <div class="col-xs-12">
        ...
        <div class="alert alert-warning">
            ...
            <p style="margin-bottom: 0; font-size: 12px;">
                ...
                Protected by: 
                <span class="label label-primary">@kaiizxxxy</span>
                <span class="label label-success">@kaiizxxxy</span>
                <span class="label label-info">@kaiizxxxy</span>
            </p>
        </div>
        @else
    ...
    ">
        ...
        ">
            ...
            <div style="display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <span style="background: #e84393; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@kaiizxxxy</span>
                <span style="background: #0984e3; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@kaiizxxxy</span>
                <span style="background: #00b894; padding: 5px 12px; border-radius: 15px; font-size: 12px;">@kaiizxxxy</span>
            </div>
        </div>
